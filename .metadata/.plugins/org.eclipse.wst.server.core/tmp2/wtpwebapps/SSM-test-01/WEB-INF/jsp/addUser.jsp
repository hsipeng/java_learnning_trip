...
<body>
  <form action="${pageContext.request.contextPath}/user/addUser">
    ...
    <td style="border: #333 1px solid; text-align: center;">age</td>
      ...
      <tr>
      <td style="border: #333 1px solid; text-align: center;"><input type="text" name="id" value="" hidden="hidden"></td>
      <td style="border: #333 1px solid; text-align: center;"><input type="text" name="user_name" value=""></td>
      ...
      <tr colspan="3" style="border: #333 1px solid; text-align: center;">
        <td style="border: #333 1px solid; text-align: center;"><input type="submit" name="添加"></td>
      </tr>
    </table>
  </form>
</body>
